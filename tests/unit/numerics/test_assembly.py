...
class _CapturingPressureCoupling(PressureCoupling):
    ...
    `tolerance`/`max_iterations` (TASK-033, 2026-08-29) and
    `periodic_pairs` (TASK-034, 2026-08-29), matching
    `register_pressure_coupling`'s new five-argument factory shape.
    """
    ...
    def __init__(
        ...
        del tolerance, max_iterations, periodic_pairs
