...
Press Escape or Enter to close it (or close the window normally):
`RenderWindow.run()` wires that up by default for every interactive
window, not just this demo -- see `src/pyflow/rendering/window.py`.
